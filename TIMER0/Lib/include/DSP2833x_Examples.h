...
#include "../../Lib/include/DSP2833x_GlobalPrototypes.h"         // Prototypes for global functions within the
                                              // .c files.

#include "../../Lib/include/DSP2833x_EPwm_defines.h"             // Macros used for PWM examples.
#include "../../Lib/include/DSP2833x_Dma_defines.h"              // Macros used for DMA examples.
#include "../../Lib/include/DSP2833x_I2c_defines.h"              // Macros used for I2C examples.
#include "../../Lib/include/LED.h"                               //为7段数码管实验使用的头文件
...
#ifndef DSP28_BIOS
#include "../../Lib/include/DSP2833x_DefaultIsr.h"
#endif


// DO NOT MODIFY THIS LINE.
#define DELAY_US(A)  DSP28x_usDelay(((((long double) A * 1000.0L) / (long double)CPU_RATE) - 9.0L) / 5.0L)
#define DELAY_MS(A)  DSP28x_usDelay(((((long double) A * 1000.0L *1000.0L) / (long double)CPU_RATE) - 9.0L) / 5.0L)
#define DELAY_S(A)   DSP28x_usDelay(((((long double) A * 1000.0L *1000.0L * 1000.0L) / (long double)CPU_RATE) - 9.0L) / 5.0L)
